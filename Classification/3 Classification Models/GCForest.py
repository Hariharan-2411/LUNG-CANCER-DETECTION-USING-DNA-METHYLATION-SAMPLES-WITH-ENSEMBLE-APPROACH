...
class gcForest(object):
    ...
    def window_slicing_pred_prob(self, X, window, shape_1X, y=None):
        ...
        if y is not None:
            ...
            #prf = lw.RIPPER(prune_size=0.66) # Or irep_clf = lw.IREP() to build a model using IREP
            #crf = lw.RIPPER(prune_size=0.33)
            ...
            print("pred_Prob_prf : ",pred_prob_prf)
            pred_prob_crf = crf.oob_decision_function_
            print("pred_Prob_crf : ",pred_prob_crf)
